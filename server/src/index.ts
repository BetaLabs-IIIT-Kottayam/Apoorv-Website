...
app.use(
  cors({
    origin: ["http://localhost:5173", "http://localhost:5174", "http://client:5173", "http://admin:5174","http://10.10.0.118:5173","http://10.10.0.118:5174"], // Explicitly allow frontend origins
